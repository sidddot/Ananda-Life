...
# Manually set values for args
#args = {"exercise_type": "push-up", "video_source": "push-up.mp4"}  # Replace "your_video_source" with the actual video source
...
# if args.get("video_source") is not None:
